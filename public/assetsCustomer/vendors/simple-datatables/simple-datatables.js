        ...
        1: [function (require, module, exports) {
            (function (global) {
                ...
                var dayjs_min = createCommonjsModule(function (t, n) {
                    t.exports = function () {
                        var t = "millisecond", n = "second", e = "minute", r = "hour", i = "day", s = "week",
                            o = "month", a = "quarter", u = "year",
                            ...
                            c = function (t, n, e) {
                                ...
                                s: c, z: function (t) {
                                    ...
                                    var e = 12 * (n.year() - t.year()) + (n.month() - t.month()), r = t.clone().add(e, o),
                                        i = n - r < 0, s = t.clone().add(e + (i ? -1 : 1), o);
                        ...
                        var M = function (t) {
                            ...
                            var r;
                            if (!t) return m;
                            if ("string" == typeof t) $[t] && (r = t), n && ($[t] = n, r = t); else {
                                var i = t.name;
                                $[i] = t, r = i
                            }
                            return e || (m = r), r
                        ...
                        var v = function () {
                            ...
                            return d.parse = function (t) {
                                ...
                                var h = this, f = !!g.u(a) || a, c = g.p(t), d = function (t, n) {
                                ...
                                }, m = this.$W, $ = this.$M, M = this.$D, D = "set" + (this.$u ? "UTC" : "");
                                switch (c) {
                                    case u:
                                    ...
                                    case o:
                                        return f ? d(1, $) : d(0, $ + 1);
                                    case s:
                                        var y = this.$locale().weekStart || 0, v = (m < y ? m + 7 : m) - y;
                                ...
                                var h, f = g.p(s), c = "set" + (this.$u ? "UTC" : ""),
                                ...
                                var e = t || "YYYY-MM-DDTHH:mm:ssZ", r = g.z(this), i = this.$locale(), s = this.$H,
                                    o = this.$m, a = this.$M, u = i.weekdays, h = i.months, c = function (t, r, i, s) {
                                ...
                                var c, d = g.p(h), l = y(t), m = 6e4 * (l.utcOffset() - this.utcOffset()), $ = this - l,
                                    M = g.m(this, l);
                    ...
                    t.exports = (r = /(\[[^[]*\])|([-:\/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, o = /\d*[^\s\d-:\/.()]+/, u = [/[+-]\d\d:?\d\d/, function (t) {
                        ...
                        DD: [i, a("day")],
                        Do: [o, function (t) {
                            var n = e.ordinal, r = t.match(/\d+/);
                            if (this.day = r[0], n) for (var i = 1; i <= 31; i += 1) n(i).replace(/\[|\]/g, "") === t && (this.day = i)
                        }],
                        M: [s, a("month")],
                        MM: [i, a("month")],
                        MMM: [o, function (t) {
                            var n = e, r = n.months, i = n.monthsShort, s = i ? i.findIndex(function (n) {
                                return n === t
                        ...
                        try {
                            var i = function (t) {
                                    for (var n = t.match(r), e = n.length, i = 0; i < e; i += 1) {
                                        var s = n[i], o = h[s], a = o && o[0], u = o && o[1];
                                        n[i] = u ? {regex: a, parser: u} : s.replace(/^\[|\]$/g, "")
                                    }
                                    return function (t) {
                                        for (var r = {}, i = 0, s = 0; i < e; i += 1) {
                                            var o = n[i];
                                            if ("string" == typeof o) s += o.length; else {
                                                var a = o.regex, u = o.parser, h = t.substr(s), f = a.exec(h)[0];
                                ...
                                }(n)(t), s = i.year, o = i.month, a = i.day, u = i.hours, f = i.minutes, c = i.seconds,
                                d = i.milliseconds, l = i.zone;
                            if (l) return new Date(Date.UTC(s, o - 1, a, u || 0, f || 0, c || 0, d || 0) + 60 * l.offset * 1e3);
                            var m = new Date, $ = s || m.getFullYear(), M = o > 0 ? o - 1 : m.getMonth(),
                                D = a || m.getDate(), y = u || 0, g = f || 0, v = c || 0, p = d || 0;
                            return e ? new Date(Date.UTC($, M, D, y, g, v, p)) : new Date($, M, D, y, g, v, p)
                        } catch (t) {
                            return new Date("")
                        }
                    }, function (t, n, r) {
                        var i = n.prototype, s = i.parse;
                        i.parse = function (t) {
                            var n = t.date, i = t.format, o = t.pl, a = t.utc;
            ...
            const isObject = t => "[object Object]" === Object.prototype.toString.call(t), isJson = t => {
                let e = !1;
                try {
                    e = JSON.parse(t)
                } catch (t) {
                ...
                for (let e = 1; e <= s; e++) if (1 == e || e == s || e >= r && e <= h) {
                    const s = t[e - 1];
                ...
                return o.forEach(e => {
                    ...
                    if (n) {
                        ...
                        if (s - e == 2) d.push(t[e]); else if (s - e != 1) {
                            const t = createElement("li", {class: "ellipsis", html: `<a href="#">${i}</a>`});
                            d.push(t)
                        }
                    }
                    d.push(e), n = e
            ...
            class Columns {
                ...
                filter(t, e, s, a) {
                    const i = this.dt;
                    if (i.filterState || (i.filterState = {originalData: i.data}), !i.filterState[t]) {
                        const e = [...a, () => !0];
                    ...
                    const n = i.filterState[t](), l = Array.from(i.filterState.originalData).filter(e => {
                        const s = e.cells[t],
                    ...
                    Promise.all(c).then(i => {
                        ...
                        Array.from(n).forEach(e => {
                            ...
                            i = c ? c(a) : "string" == typeof a ? a.replace(/(\$|,|\s|%)/g, "") : a, parseFloat(i) == i ? r[o++] = {
                                value: Number(i),
                                row: e
                            } : l[h++] = {value: "string" == typeof a ? a.toLowerCase() : a, row: e}
            ...
            const dataToTable = function (t) {
                ...
                if ((t = t || this.options.data).headings) {
                    ...
                    t.headings.forEach(t => {
                        const e = createElement("th", {html: t});
                        s.appendChild(e)
                    }), e.appendChild(s)
                }
            ...
            class DataTable {
                ...
                init(t) {
                    ...
                    Object.assign(this.options, t || {}), this.currentPage = 1, this.onFirstPage = !0, this.hiddenColumns = [], this.columnRenderers = [], this.selectedColumns = [], this.render(), setTimeout(() => {
                        this.emit("datatable.init"), this.initialized = !0, this.options.plugins && Object.entries(this.options.plugins).forEach(([t, e]) => {
                            this[t] && "function" == typeof this[t] && (this[t] = this[t](e, {createElement: createElement}), e.enabled && this[t].init && "function" == typeof this[t].init && this[t].init())
                        })
                    }, 10)
                }
                ...
                render(t) {
                    ...
                    if (e.data && dataToTable.call(this), e.ajax) {
                        const t = e.ajax, s = new XMLHttpRequest, a = t => {
                            this.emit("datatable.ajax.progress", t, s)
                        }, i = e => {
                            if (4 === s.readyState) if (this.emit("datatable.ajax.loaded", e, s), 200 === s.status) {
                                const a = {};
                    ...
                    if (this.body = this.table.tBodies[0], this.head = this.table.tHead, this.foot = this.table.tFoot, this.body || (this.body = createElement("tbody"), this.table.appendChild(this.body)), this.hasRows = this.body.rows.length > 0, !this.head) {
                        const t = createElement("thead"), s = createElement("tr");
                    ...
                    if (this.headings = [], this.hasHeadings = this.head.rows.length > 0, this.hasHeadings && (this.header = this.head.rows[0], this.headings = [].slice.call(this.header.cells)), e.header || this.head && this.table.removeChild(this.table.tHead), e.footer ? this.head && !this.foot && (this.foot = createElement("tfoot", {html: this.head.innerHTML}), this.table.appendChild(this.foot)) : this.foot && this.table.removeChild(this.table.tFoot), this.wrapper = createElement("div", {class: "dataTable-wrapper dataTable-loading"}), s += "<div class='dataTable-top'>", s += e.layout.top, s += "</div>", e.scrollY.length ? s += `<div class='dataTable-container' style='height: ${e.scrollY}; overflow-Y: auto;'></div>` : s += "<div class='dataTable-container'></div>", s += "<div class='dataTable-bottom'>", s += e.layout.bottom, s = (s += "</div>").replace("{info}", e.paging ? "<div class='dataTable-info'></div>" : ""), e.paging && e.perPageSelect) {
                        ...
                        t += e.labels.perPage, t += "<label></label></div>";
                    ...
                    if (e.searchable) {
                        const t = `<div class='dataTable-search'><input class='dataTable-input' placeholder='${e.labels.placeholder}' type='text'>
                            </div>`;
                        s = s.replace("{search}", t)
                    } else s = s.replace("{search}", "");
                    this.hasHeadings && this.render("header"), this.table.classList.add("dataTable-table");
                    const a = createElement("ul", {class: "pagination pagination-primary float-end dataTable-pagination"}),
                        i = createElement("ul");
                ...
                renderHeader() {
                    this.labels = [], this.headings && this.headings.length && this.headings.forEach((t, e) => {
                        if (this.labels[e] = t.textContent, t.firstElementChild && t.firstElementChild.classList.contains("dataTable-sorter") && (t.innerHTML = t.firstElementChild.innerHTML), t.sortable = "false" !== t.getAttribute("data-sortable"), t.originalCellIndex = e, this.options.sortable && t.sortable) {
                            const e = createElement("a", {href: "#", class: "dataTable-sorter", html: t.innerHTML});
                    ...
                    if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                        ...
                        if (this.columnWidths = [], this.table.tHead) {
                            if (this.options.scrollY.length && ((e = createElement("thead")).appendChild(createElement("tr")), e.style.height = "0px", this.headerTable && (this.table.tHead = this.headerTable.tHead)), this.activeHeadings.forEach(t => {
                                ...
                                const a = t.offsetWidth, i = a / this.rect.width * 100;
                                ...
                                if (!this.headerTable) {
                                    this.headerTable = createElement("table", {class: "dataTable-table"});
                                    const e = createElement("div", {class: "dataTable-headercontainer"});
                ...
                search(t) {
                    return !!this.hasRows && (t = t.toLowerCase(), this.currentPage = 1, this.searching = !0, this.searchData = [], t.length ? (this.clear(), this.data.forEach((e, s) => {
                        ...
                        t.split(" ").reduce((t, s) => {
                            let a = !1, i = null, n = null;
                            for (let t = 0; t < e.cells.length; t++) if ((n = (i = e.cells[t]).hasAttribute("data-content") ? i.getAttribute("data-content") : i.textContent).toLowerCase().includes(s) && this.columns(i.cellIndex).visible()) {
                                a = !0;
                                break
                            }
                            return t && a
                ...
                insert(t) {
                    ...
                    if (isObject(t)) {
                        if (t.headings && !this.hasHeadings && !this.hasRows) {
                            const e = createElement("tr");
                            t.headings.forEach(t => {
                                const s = createElement("th", {html: t});
                                e.appendChild(s)
                ...
                export(t) {
                    ...
                    if (h.type) {
                        if ("txt" !== h.type && "csv" !== h.type || (s[0] = this.header), h.selection) if (isNaN(h.selection)) {
                            if (Array.isArray(h.selection)) for (i = 0; i < h.selection.length; i++) s = s.concat(this.pages[h.selection[i] - 1])
                        } else s = s.concat(this.pages[h.selection - 1]); else s = s.concat(this.activeRows);
                        if (s.length) {
                            if ("txt" === h.type || "csv" === h.type) {
                                for (l = "", i = 0; i < s.length; i++) {
                                    for (n = 0; n < s[i].cells.length; n++) if (!h.skipColumn.includes(e[n].originalCellIndex) && this.columns(e[n].originalCellIndex).visible()) {
                                ...
                                for (n = 0; n < s.length; n++) for (a[n] = a[n] || {}, i = 0; i < e.length; i++) !h.skipColumn.includes(e[i].originalCellIndex) && this.columns(e[i].originalCellIndex).visible() && (a[n][e[i].textContent] = s[n].cells[i].textContent);
                ...
                print() {
                    const t = this.activeHeadings, e = this.activeRows, s = createElement("table"),
                        a = createElement("thead"), i = createElement("tbody"), n = createElement("tr");
                    t.forEach(t => {
                        n.appendChild(createElement("th", {html: t.textContent}))
                    }), a.appendChild(n), e.forEach(t => {
                        const e = createElement("tr");
                        Array.from(t.cells).forEach(t => {
                            e.appendChild(createElement("td", {html: t.textContent}))
                        }), i.appendChild(e)
                ...
                setMessage(t) {
                    let e = 1;
                    this.hasRows ? e = this.data[0].cells.length : this.activeHeadings.length && (e = this.activeHeadings.length), this.wrapper.classList.add("dataTable-empty"), this.label && (this.label.innerHTML = ""), this.totalPages = 0, this.render("pager"), this.clear(createElement("tr", {html: `<td class="dataTables-empty" colspan="${e}">${t}</td>`}))
                }
