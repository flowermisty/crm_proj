(() => {
    var e, t = {
        750: () => {
            ...
            function i(e, t, i, o) {
                ...
                var r, n = window.getComputedStyle(e), a = parseFloat(n.getPropertyValue("height")),
                    ...
                    c = parseFloat(n.getPropertyValue("margin-bottom")), u = a / t, v = s / t, p = l / t, y = d / t,
                    h = c / t;
            ...
            var o = function () {
                ...
                return r = o, (n = [{
                    key: "init", value: function () {
                        ...
                        for (var t = document.querySelectorAll(".sidebar-item.has-sub"), o = function () {
                            ...
                            t[r].querySelector(".sidebar-link").addEventListener("click", (function (t) {
                                ...
                                o.classList.contains("active") && (o.style.display = "block"), "none" == o.style.display ? o.classList.add("active") : o.classList.remove("active"), function (e, t, o) {
                    ...
                    key: "deleteBackdrop", value: function () {
                        var e = document.querySelector(".sidebar-backdrop");
                        e && e.remove()
                    }
                }, {
                    key: "toggleOverflowBody", value: function (e) {
                        var t = this.sidebarEL.classList.contains("active"), i = document.querySelector("body");
    ...
    o.m = t, e = [], o.O = (t, i, r, n) => {
        ...
        var e = {254: 0, 12: 0, 348: 0, 37: 0, 673: 0, 464: 0, 770: 0, 376: 0, 825: 0};
        o.O.j = t => 0 === e[t];
        var t = (t, i) => {
            var r, n, [a, s, l] = i, d = 0;
