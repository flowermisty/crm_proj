    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-12 order-md-1 order-last">
                <h3 class="text-title text-muted">Coupang 발주서 변경</h3>
            ...
            <div class="col-12 col-md-12 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">쿠팡 변환</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-12 col-md-12">
                <div class="card">
                    <div class="card-header" style="padding-bottom:0 !important;">
                        <h5 class="card-title text-muted">Coupang 멀티 발주서 변경 프로그램</h5>
                    </div>
                    <div class="card-content" style="padding-bottom: 2%;">
                        <div class="card-body" style="padding-top: 4% !important;">
                            <form id="fm" method="post" action="<?= base_url("convert/coupangResult") ?>"
                                  enctype="multipart/form-data">
                                <div class="row">

                                    <div class="col-md-6">
                                        <!-- Basic file uploader -->
                                        <input type="file" class="multiple-files-filepond" name="excel_file[]"
                                               id="our-test" multiple="multiple">
                                        <input type="submit" class="btn btn-primary" value="upload"
                                               style="float: right; margin-top:2%;">
                                    </div>

                                    <div class="col-md-6">
                                        <div style="display: flex; margin-top:2%; margin-left: 3%">
                                            <div class="form-check form-check-primary"
                                                ...
                                                <input class="form-check-input" type="radio" name="kind"
                                                       id="kind" value="1" style="padding:20%;" >
                                            ...
                                            <div class="form-check form-check-success"
                                                ...
                                                <input class="form-check-input" type="radio" name="kind"
                                                       id="kind" value="2" style="padding:15%;" checked>
                            ...
                            <img src="/assets2/images/convert/coupang.gif"/>
                        </div>
                    </div>
                </div>
            </div>
