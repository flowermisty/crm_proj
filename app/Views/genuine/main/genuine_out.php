                                ...
                                <div class="col-md-12 col-12" id="searchObjContainer" style="padding-left: 0;">
                                    <div class="form-group" style="display: flex;">
                                        ...
                                        <div class="col-3" style="margin-left: 1%; padding: 0.5%;">
                                            <button type="button" id="searchSubmit" class="btn btn-primary me-1 mb-1" onclick="modeCheckSubmit('<?=$signal?>')">검색
                                            </button>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-content">
                    ...
                    <form action="#">
                                ...
                                <div class="col-12 inNoutProductWrap">
                                    ...
                                    <div class="inNoutProduct" id="0">
                                        <div class="form-group col-6" style="display: flex;">
                                            ...
                                            <div class="col-4">
                                                <select name="pcate1[]" id="pcate1" onchange="getCategory2()">
                        ...
                        <div class="modal-footer col-12">
                            ...
                            <button type="button" class="btn btn-light-secondary" data-bs-dismiss="modal" id="modal_close" onclick="modalClose();">
